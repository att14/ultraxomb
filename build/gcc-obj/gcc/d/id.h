...
struct Id
{
    ...
    static Identifier *GNU_attribute;
    static Identifier *GNU_set_attribute;
    static Identifier *_GNU_attribute;
    static Identifier *_GNU_set_attribute;
