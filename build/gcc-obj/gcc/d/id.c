...
Identifier *Id::lib;
Identifier *Id::msg;
Identifier *Id::GNU_attribute;
Identifier *Id::GNU_set_attribute;
Identifier *Id::_GNU_attribute;
Identifier *Id::_GNU_set_attribute;
...
void Id::initialize()
{
    ...
    GNU_attribute = Lexer::idPool("attribute");
    GNU_set_attribute = Lexer::idPool("set_attribute");
    _GNU_attribute = Lexer::idPool("GNU_attribute");
    _GNU_set_attribute = Lexer::idPool("GNU_set_attribute");
