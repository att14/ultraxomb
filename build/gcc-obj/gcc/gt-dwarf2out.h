...
void
gt_ggc_mx_vcall_insn (void *x_p)
{
  struct vcall_insn * const x = (struct vcall_insn *)x_p;
...
void
gt_ggc_mx_VEC_vcall_entry_gc (void *x_p)
{
  struct VEC_vcall_entry_gc * const x = (struct VEC_vcall_entry_gc *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      {
        size_t i0;
...
void
gt_ggc_mx_VEC_dcall_entry_gc (void *x_p)
{
  struct VEC_dcall_entry_gc * const x = (struct VEC_dcall_entry_gc *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_ggc_m_9tree_node ((*x).base.vec[i0].poc_decl);
          gt_ggc_m_10die_struct ((*x).base.vec[i0].targ_die);
        }
      }
    }
}
...
void
gt_ggc_mx_VEC_die_arg_entry_gc (void *x_p)
{
  struct VEC_die_arg_entry_gc * const x = (struct VEC_die_arg_entry_gc *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      {
        size_t i0;
        ...
        for (i0 = 0; i0 != l0; i0++) {
          ...
          gt_ggc_m_9tree_node ((*x).base.vec[i0].arg);
        }
      }
    }
}
...
void
gt_ggc_m_P10vcall_insn4htab (void *x_p)
{
  ...
  if (ggc_test_and_set_mark (x))
    {
      if ((*x).entries != NULL) {
        ...
        for (i0 = 0; i0 != (size_t)(((*x)).size); i0++) {
          gt_ggc_m_10vcall_insn ((*x).entries[i0]);
        }
        ggc_mark ((*x).entries);
      }
    }
...
void
gt_pch_nx_vcall_insn (void *x_p)
{
  struct vcall_insn * const x = (struct vcall_insn *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_10vcall_insn, gt_ggc_e_10vcall_insn))
    {
    }
}

void
gt_pch_nx_VEC_vcall_entry_gc (void *x_p)
{
  struct VEC_vcall_entry_gc * const x = (struct VEC_vcall_entry_gc *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_18VEC_vcall_entry_gc, gt_ggc_e_18VEC_vcall_entry_gc))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).num);
...
void
gt_pch_nx_VEC_dcall_entry_gc (void *x_p)
{
  struct VEC_dcall_entry_gc * const x = (struct VEC_dcall_entry_gc *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_18VEC_dcall_entry_gc, gt_ggc_e_18VEC_dcall_entry_gc))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_pch_n_9tree_node ((*x).base.vec[i0].poc_decl);
          gt_pch_n_10die_struct ((*x).base.vec[i0].targ_die);
        }
      }
    }
}
...
void
gt_pch_nx_VEC_die_arg_entry_gc (void *x_p)
{
  struct VEC_die_arg_entry_gc * const x = (struct VEC_die_arg_entry_gc *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_20VEC_die_arg_entry_gc, gt_ggc_e_20VEC_die_arg_entry_gc))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).num);
        for (i0 = 0; i0 != l0; i0++) {
          ...
          gt_pch_n_9tree_node ((*x).base.vec[i0].arg);
        }
      }
    }
}
...
{
  struct comdat_type_struct * const x = (struct comdat_type_struct *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_18comdat_type_struct, gt_ggc_e_18comdat_type_struct))
    {
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_P10vcall_insn4htab, gt_types_enum_last))
    {
      if ((*x).entries != NULL) {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(((*x)).size); i0++) {
          gt_pch_n_10vcall_insn ((*x).entries[i0]);
        }
        gt_pch_note_object ((*x).entries, x, gt_pch_p_P10vcall_insn4htab, gt_types_enum_last);
      }
    }
}
...
void
gt_pch_p_10vcall_insn (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct vcall_insn * const x ATTRIBUTE_UNUSED = (struct vcall_insn *)x_p;
}

void
gt_pch_p_18VEC_vcall_entry_gc (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct VEC_vcall_entry_gc * const x ATTRIBUTE_UNUSED = (struct VEC_vcall_entry_gc *)x_p;
  {
    size_t i0;
    size_t l0 = (size_t)(((*x).base).num);
    for (i0 = 0; i0 != l0; i0++) {
...
void
gt_pch_p_18VEC_dcall_entry_gc (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct VEC_dcall_entry_gc * const x ATTRIBUTE_UNUSED = (struct VEC_dcall_entry_gc *)x_p;
  {
    size_t i0;
    size_t l0 = (size_t)(((*x).base).num);
    for (i0 = 0; i0 != l0; i0++) {
      if ((void *)(x) == this_obj)
        op (&((*x).base.vec[i0].poc_decl), cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).base.vec[i0].targ_die), cookie);
    }
  }
}
...
void
gt_pch_p_20VEC_die_arg_entry_gc (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct VEC_die_arg_entry_gc * const x ATTRIBUTE_UNUSED = (struct VEC_die_arg_entry_gc *)x_p;
  {
    size_t i0;
    size_t l0 = (size_t)(((*x).base).num);
    for (i0 = 0; i0 != l0; i0++) {
...
gt_pch_p_18comdat_type_struct (ATTRIBUTE_UNUSED void *this_obj,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct comdat_type_struct * const x ATTRIBUTE_UNUSED = (struct comdat_type_struct *)x_p;
  if ((void *)(x) == this_obj)
...
void
gt_pch_p_P10vcall_insn4htab (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
      ...
      ATTRIBUTE_UNUSED void * cookie)
{
  if (fde_table != NULL) {
    ...
    for (i0 = 0; i0 != (size_t)(fde_table_allocated); i0++) {
      ...
      if ((void *)(fde_table) == this_obj)
        op (&(fde_table[i0].dw_fde_switch_cfi), cookie);
    }
    if ((void *)(&fde_table) == this_obj)
      op (&(fde_table), cookie);
  }
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_dwarf2out_h[] = {
  ...
  },
  {
    ...
    &gt_ggc_mx_VEC_die_arg_entry_gc,
    &gt_pch_nx_VEC_die_arg_entry_gc
  },
  {
  ...
  },
  {
    &vcall_insn_table,
    1,
    sizeof (vcall_insn_table),
    &gt_ggc_m_P10vcall_insn4htab,
  ...
  },
  {
    ...
    1,
    sizeof (vcall_table),
    &gt_ggc_mx_VEC_vcall_entry_gc,
    &gt_pch_nx_VEC_vcall_entry_gc
  },
  {
    &dcall_table,
    1,
    sizeof (dcall_table),
    &gt_ggc_mx_VEC_dcall_entry_gc,
    &gt_pch_nx_VEC_dcall_entry_gc
  },
  {
    &ranges_by_label,
    1,
...
EXPORTED_CONST struct ggc_root_tab gt_pch_rs_gt_dwarf2out_h[] = {
  ...
  { &debug_str_hash_forced, 1, sizeof (debug_str_hash_forced), NULL, NULL },
