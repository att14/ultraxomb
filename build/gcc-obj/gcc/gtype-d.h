  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_9tree_node ((*x).names_end);
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_13binding_level, gt_ggc_e_13binding_level))
    {
      ...
      gt_pch_n_9tree_node ((*x).names_end);
...
extern const struct ggc_root_tab gt_ggc_r_gt_sparc_h[];
