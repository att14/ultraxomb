...
#line 53 "../../gcc-4.6.1/gcc/config/sparc/constraints.md"
...
{
  return (GET_CODE (op) == CONST_DOUBLE) && (
#line 61 "../../gcc-4.6.1/gcc/config/sparc/constraints.md"
...
#line 106 "../../gcc-4.6.1/gcc/config/sparc/constraints.md"
...
{
  return (GET_CODE (op) == CONST_DOUBLE) && (
#line 111 "../../gcc-4.6.1/gcc/config/sparc/constraints.md"
(fp_sethi_p (op)));
}
static inline bool
...
{
  return (GET_CODE (op) == CONST_DOUBLE) && (
#line 116 "../../gcc-4.6.1/gcc/config/sparc/constraints.md"
(fp_mov_p (op)));
}
static inline bool
...
{
  return (GET_CODE (op) == CONST_DOUBLE) && (
#line 121 "../../gcc-4.6.1/gcc/config/sparc/constraints.md"
(fp_high_losum_p (op)));
}
static inline bool
...
{
  return (
#line 126 "../../gcc-4.6.1/gcc/config/sparc/constraints.md"
(TARGET_ARCH32)) && ((GET_CODE (op) == MEM || GET_CODE (op) == REG) && (
#line 128 "../../gcc-4.6.1/gcc/config/sparc/constraints.md"
...
{
  return (
#line 133 "../../gcc-4.6.1/gcc/config/sparc/constraints.md"
(TARGET_ARCH32)) && ((GET_CODE (op) == REG) && (((
#line 135 "../../gcc-4.6.1/gcc/config/sparc/constraints.md"
(REGNO (op) < FIRST_PSEUDO_REGISTER)) || (!(
#line 136 "../../gcc-4.6.1/gcc/config/sparc/constraints.md"
(reload_in_progress && reg_renumber [REGNO (op)] < 0)))) && (
#line 137 "../../gcc-4.6.1/gcc/config/sparc/constraints.md"
...
satisfies_constraint_W (rtx op)
{
  ...
  return 
#line 143 "../../gcc-4.6.1/gcc/config/sparc/constraints.md"
(memory_ok_for_ldd (op));
}
static inline bool
satisfies_constraint_Y (rtx op)
{
  enum machine_mode mode = GET_MODE (op);
  return (GET_CODE (op) == CONST_VECTOR) && (
#line 148 "../../gcc-4.6.1/gcc/config/sparc/constraints.md"
(const_zero_operand (op, mode)));
}
#endif /* tm-constrs.h */
