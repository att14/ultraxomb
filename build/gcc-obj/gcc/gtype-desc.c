    ...
    {
      {
        ...
        for (i0 = 0; i0 != l0; i0++) {
          if ((*x).base.vec[i0].jump_functions != NULL) {
            ...
            ggc_mark ((*x).base.vec[i0].jump_functions);
          }
        }
      }
    }
...
void
gt_ggc_mx_cgraph_node_set_def (void *x_p)
{
  struct cgraph_node_set_def * const x = (struct cgraph_node_set_def *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_m_P27cgraph_node_set_element_def4htab ((*x).hashtab);
      gt_ggc_m_22VEC_cgraph_node_ptr_gc ((*x).nodes);
    }
}

void
gt_ggc_mx_cgraph_node_set_element_def (void *x_p)
{
  struct cgraph_node_set_element_def * const x = (struct cgraph_node_set_element_def *)x_p;
  if (ggc_test_and_set_mark (x))
    {
...
void
gt_ggc_mx_VEC_cgraph_node_ptr_gc (void *x_p)
{
  struct VEC_cgraph_node_ptr_gc * const x = (struct VEC_cgraph_node_ptr_gc *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_ggc_m_11cgraph_node ((*x).base.vec[i0]);
        }
      }
    }
}
  ...
  if (ggc_test_and_set_mark (x))
    {
      if ((*x).entries != NULL) {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(((*x)).size); i0++) {
          gt_ggc_m_27cgraph_node_set_element_def ((*x).entries[i0]);
        }
        ggc_mark ((*x).entries);
      }
    }
...
void
gt_pch_nx_cgraph_node_set_def (void *x_p)
{
  struct cgraph_node_set_def * const x = (struct cgraph_node_set_def *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_19cgraph_node_set_def, gt_ggc_e_19cgraph_node_set_def))
    {
      gt_pch_n_P27cgraph_node_set_element_def4htab ((*x).hashtab);
      gt_pch_n_22VEC_cgraph_node_ptr_gc ((*x).nodes);
    }
}

void
gt_pch_nx_cgraph_node_set_element_def (void *x_p)
{
  struct cgraph_node_set_element_def * const x = (struct cgraph_node_set_element_def *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_27cgraph_node_set_element_def, gt_ggc_e_27cgraph_node_set_element_def))
    {
...
void
gt_pch_nx_VEC_cgraph_node_ptr_gc (void *x_p)
{
  struct VEC_cgraph_node_ptr_gc * const x = (struct VEC_cgraph_node_ptr_gc *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_22VEC_cgraph_node_ptr_gc, gt_ggc_e_22VEC_cgraph_node_ptr_gc))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_pch_n_11cgraph_node ((*x).base.vec[i0]);
        }
      }
    }
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_P27cgraph_node_set_element_def4htab, gt_types_enum_last))
    {
      if ((*x).entries != NULL) {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(((*x)).size); i0++) {
          gt_pch_n_27cgraph_node_set_element_def ((*x).entries[i0]);
        }
        gt_pch_note_object ((*x).entries, x, gt_pch_p_P27cgraph_node_set_element_def4htab, gt_types_enum_last);
      }
    }
}
      ...
      if ((*x).base.vec[i0].jump_functions != NULL) {
        ...
        for (i1 = 0; i1 != (size_t)(((*x).base.vec[i0]).argument_count); i1++) {
          switch (((*x).base.vec[i0].jump_functions[i1]).type)
            ...
            case IPA_JF_PASS_THROUGH:
              if ((void *)((*x).base.vec[i0].jump_functions) == this_obj)
                op (&((*x).base.vec[i0].jump_functions[i1].value.pass_through.operand), cookie);
              break;
            case IPA_JF_ANCESTOR:
              if ((void *)((*x).base.vec[i0].jump_functions) == this_obj)
...
void
gt_pch_p_19cgraph_node_set_def (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct cgraph_node_set_def * const x ATTRIBUTE_UNUSED = (struct cgraph_node_set_def *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).hashtab), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).nodes), cookie);
...
void
gt_pch_p_27cgraph_node_set_element_def (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct cgraph_node_set_element_def * const x ATTRIBUTE_UNUSED = (struct cgraph_node_set_element_def *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).node), cookie);
}

void
gt_pch_p_22VEC_cgraph_node_ptr_gc (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct VEC_cgraph_node_ptr_gc * const x ATTRIBUTE_UNUSED = (struct VEC_cgraph_node_ptr_gc *)x_p;
  {
    size_t i0;
    size_t l0 = (size_t)(((*x).base).num);
    for (i0 = 0; i0 != l0; i0++) {
