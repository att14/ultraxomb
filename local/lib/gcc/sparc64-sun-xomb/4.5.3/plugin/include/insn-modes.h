...
enum machine_mode
{
  ...
  V4QImode,                /* config/sparc/sparc-modes.def:47 */
  V2HImode,                /* config/sparc/sparc-modes.def:47 */
  V8QImode,                /* config/sparc/sparc-modes.def:46 */
  V4HImode,                /* config/sparc/sparc-modes.def:46 */
  V2SImode,                /* config/sparc/sparc-modes.def:46 */
  MAX_MACHINE_MODE,
