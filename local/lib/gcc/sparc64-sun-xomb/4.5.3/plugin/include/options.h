...
enum opt_code
{
  ...
  OPT_cpp,                                   /* -cpp */
  OPT_d,                                     /* -d */
  OPT_debuglib_,                             /* -debuglib= */
  OPT_defaultlib_,                           /* -defaultlib= */
  ...
  OPT_fd_verbose,                            /* -fd-verbose */
  OPT_fd_version_1,                          /* -fd-version=1 */
  OPT_fd_vtls,                               /* -fd-vtls */
  ...
  OPT_fdoc,                                  /* -fdoc */
  OPT_fdoc_dir_,                             /* -fdoc-dir= */
  OPT_fdoc_file_,                            /* -fdoc-file= */
  OPT_fdoc_inc_,                             /* -fdoc-inc= */
  ...
  OPT_femit_templates,                       /* -femit-templates */
  OPT_femit_templates_,                      /* -femit-templates= */
  ...
  OPT_fignore_unknown_pragmas,               /* -fignore-unknown-pragmas */
  ...
  OPT_fintfc,                                /* -fintfc */
  OPT_fintfc_dir_,                           /* -fintfc-dir= */
  OPT_fintfc_file_,                          /* -fintfc-file= */
  ...
  OPT_m32,                                   /* -m32 */
  OPT_m64,                                   /* -m64 */
  OPT_mapp_regs,                             /* -mapp-regs */
  OPT_mbig_endian,                           /* -mbig-endian */
  OPT_mcmodel_,                              /* -mcmodel= */
  OPT_mcpu_,                                 /* -mcpu= */
  OPT_mfaster_structs,                       /* -mfaster-structs */
  OPT_mfpu,                                  /* -mfpu */
  OPT_mhard_float,                           /* -mhard-float */
  OPT_mhard_quad_float,                      /* -mhard-quad-float */
  OPT_mimpure_text,                          /* -mimpure-text */
  OPT_mlittle_endian,                        /* -mlittle-endian */
  OPT_mptr32,                                /* -mptr32 */
  OPT_mptr64,                                /* -mptr64 */
  OPT_mrelax,                                /* -mrelax */
  OPT_msoft_float,                           /* -msoft-float */
  OPT_msoft_quad_float,                      /* -msoft-quad-float */
  OPT_mstack_bias,                           /* -mstack-bias */
  OPT_mstd_struct_return,                    /* -mstd-struct-return */
  OPT_mtune_,                                /* -mtune= */
  OPT_munaligned_doubles,                    /* -munaligned-doubles */
  OPT_mv8plus,                               /* -mv8plus */
  OPT_mvis,                                  /* -mvis */
  OPT_nocpp,                                 /* -nocpp */
  OPT_nophoboslib,                           /* -nophoboslib */
  ...
  OPT_static_libphobos,                      /* -static_libphobos */
