...
static inline rtx gen_adddi3_insn_sp32              (rtx, rtx, rtx);
static inline rtx
gen_adddi3_insn_sp32(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_addx                          (rtx, rtx, rtx);
extern rtx        gen_addsi3                        (rtx, rtx, rtx);
static inline rtx gen_subdi3_insn_sp32              (rtx, rtx, rtx);
static inline rtx
gen_subdi3_insn_sp32(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
